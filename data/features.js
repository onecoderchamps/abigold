...
export const featureItems2 = [
  {
    ...
    title: "Terpercaya",
    description:
      "Kualitas emas dgn sertifikasi Sucofindo dan Pegadaian",
  },
  {
    id: 2,
    className: "col-lg-6",
    ...
    description:
      "Desain ABI Gold mewah dan eksklusif",
  },
  {
    id: 3,
    className: "col-lg-6",
    ...
    title: "Harga Terbaru",
    description:
      "Buyback dengan proses real-time",
  },
  {
    id: 4,
    className: "col-lg-6",
    ...
    title: "Cek Keaslian ABI Gold",
    description:
      "QR Code untuk cek keaslian & kemurnian ABI Gold",
  },
];
